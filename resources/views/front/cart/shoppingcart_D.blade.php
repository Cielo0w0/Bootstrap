...
<div class="success" style="padding: 20px 0;">
    ...
    <!-- 訂單明細 -->
    <div class="list">
        <h2 style="font-size: 1.5rem; line-height: 2rem; color: #374151;margin-bottom: 24px;">訂單明細</h2>
        <div class="div">
            @php
            $qty = 0;
            @endphp
            ...
            @endphp
            <!-- 第一層 -->
            <div class="item-1 d-flex justify-content-between" style="padding:24px 32px 24px 0;border-width: 0 0 1px 0 ; border-style: solid; border-color: #e5e7eb;">
                <!-- 左邊資訊 -->
                <div class="d-flex align-items-center ">
                    <img src="{{ asset($product->photo) }}" class=""
                        style="width: 60px; height: 60px; border-radius: 50%;">

                    <div class="d-flex flex-column align-items-start justify-content-center "
                        style="margin-left: 12px;">
                        <span class="" style="font-weight: 500;">{{ $product->product_name }}</span>
                ...
                <div class="d-flex ">
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="padding-right: 32px;">
                        <div class="" style="font-size: .875rem; line-height: 1.25rem;">x {{ $detail->qty }}</div>
                    </div>

                    <!-- 價格 -->
                    <div class="pr-8 d-flex  justify-content-center align-items-center">
                        <span class=""
                            style="font-size: .75rem; line-height: 1rem;font-weight: 500; ">${{ number_format($product->price*$detail->qty) }}</span>
                    </div>
                </div>
            </div>
            @endforeach
...
<div class="count d-flex justify-content-end flex-column align-items-end"
    ...
    <div class="d-flex justify-content-between align-items-center w-25">
        ...
        <span class="" style="color: rgba(31,41,55);font-size: 1.125rem; line-height: 1.75rem;font-weight: 700;">
            ${{ number_format($order->price) }}</span>
    </div>
    <div class="d-flex justify-content-between align-items-center w-25">
        <span class=""
    ...
    <div class="d-flex justify-content-between align-items-center w-25">
        ...
        <span class="" style="color: rgba(31,41,55);font-size: 1.125rem; line-height: 1.75rem;font-weight: 700;">
            ${{ number_format($order->price+$order->shipping_fee) }}</span>
    </div>
</div>
<!-- 返回&下一步 -->
