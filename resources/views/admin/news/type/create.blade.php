        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ asset('/admin/news/type/store') }}" method="post">
                            @csrf

                            <div class="form-group">
                                <label for="news_type_name">最新消息種類名稱</label>
                                <input type="text" class="form-control" id="news_type_name" name="news_type_name">
                            </div>
